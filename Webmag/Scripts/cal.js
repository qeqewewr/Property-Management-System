...
(function($) { // create private scope (inside you can use $ instead of jQuery)
    ...
    $.fn.simpleDatepicker = function(options) {
		...
		function newDatepickerHTML () {
			...
			jQuery("tfoot",table).append('<tr><td colspan="2"><span class="today">今日</span></td><td colspan="3">&nbsp;</td><td colspan="2"><span class="close">关闭</span></td></tr>');
