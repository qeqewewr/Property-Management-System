<%@ Page Language="C#" AutoEventWireup="true" CodeFile="surveyLesseeView.aspx.cs" Inherits="Webmag_Employe_surveyManage_surveyLesseeView" %>
        ...
        <%
          ...
          %>
                 <tr onMouseOver="this.style.backgroundColor='#f3f3f3';return true;"
                  ...
                  <td>
							<a class="btn" href="surveyWrite.aspx?pid=<%= surveys[i].ID%>">填写问卷</a>
