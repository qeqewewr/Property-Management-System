<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddDepartment.aspx.cs" Inherits="BLL_informang_departmang_AddDepartment" %>
...
<body>
  ...
  <div runat="server" >
    ...
    <form name="editDepartment" action="SaveDepartmentInfo.aspx" onsubmit="return checkForm()" method="post" >
        ...
        <table class="addTable" width="100%" cellspacing="0" cellpadding="0" style="border-collapse: collapse;">
			...
			<tr >
             ...
             <tr>
               ...
               <td  align="left">&nbsp; &nbsp; &nbsp; 
    				<input class="inputText" id="departmentID" type="text" size="26" name="departmentID" value="" />&nbsp;&nbsp;&nbsp;
            ...
            <tr>
               ...
               <td  align="left">&nbsp; &nbsp; &nbsp; 
    				<input class="inputText" id="departmentName" type="text" size="26" name="departmentName" value="" />&nbsp;&nbsp;&nbsp;
            ...
            <tr>
               ...
               <td  align="left">&nbsp; &nbsp; &nbsp; 
    				<input class="inputText" id="Text1" type="text" size="26" name="departmentManager" value="" />&nbsp;&nbsp;&nbsp;
            ...
            <tr >
               ...
               <td  align="left">&nbsp; &nbsp; &nbsp; 
    		        <input class="inputText" id="departmentAddress" type="text" size="26" name="departmentAddress" value="" />&nbsp;&nbsp;&nbsp;
    		   </td>
            </tr>
    		...
    		<tr>				
    			<td class="buttonGroup" colspan="2">&nbsp; &nbsp; &nbsp;
					...
					<input name="btnClose" type="button" class="closeBtn" id="btnClose" onclick="window.location.href='ViewDepartment.aspx?pageno=1 '" value=""/>										
    			</td>
