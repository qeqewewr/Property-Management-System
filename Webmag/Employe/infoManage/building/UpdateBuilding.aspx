<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateBuilding.aspx.cs" Inherits="Webmag_Employe_infoManage_building_UpdateBuilding" %>
...
<body>
  ...
  <div id="Div1" runat="server" >
    ...
    <form name="UpdateBuilding" action="DoUpdate.aspx?pageno=<%= pageno %>&oldid=<%=oldid %>" id="example" onsubmit="return checkForm()" method="post" enctype="multipart/form-data" >
        ...
        <table class="addTable" width="100%" cellspacing="0" cellpadding="0" style="border-collapse: collapse;">
			...
			<tr >
             ...
             <tr>
               ...
               <td  align="left">&nbsp; &nbsp; &nbsp; 
    				<input class="inputText" id="buildingID" type="text" size="26" readonly="readonly" name="buildingID" value="<%= build.ID %>" />&nbsp;&nbsp;&nbsp;
            ...
            <tr>
               ...
               <td  align="left">&nbsp; &nbsp; &nbsp; 
    				<input class="inputText" id="buildingName" type="text" size="26" readonly="readonly" name="buildingName" value="<%=build.Name %>" />&nbsp;&nbsp;&nbsp;
            ...
            <tr >
               ...
               <td  align="left" rowspan="2" >&nbsp;&nbsp;&nbsp;&nbsp;部门
                    ...
                    <br />
    				&nbsp; &nbsp; &nbsp; 
                    <input class="inputText" id="buildingAdmin"  name="buildingAdmin" type="text" size="26" value="<%= build.AdminID %>" />&nbsp;&nbsp;&nbsp;
            ...
            <tr>
               ...
               <td  align="left">&nbsp; &nbsp; &nbsp; 
    				<input class="inputText" id="buildingPos" type="text" size="26" name="buildingPos" value="<%= build.Position %>" />&nbsp;&nbsp;&nbsp;
            ...
            <tr >
               ...
               <td  align="left">&nbsp; &nbsp; &nbsp; 
    		        <input class="inputText" id="buildingArea" type="text" size="26" name="buildingArea" value="<%= build.Area %>" />&nbsp;&nbsp;&nbsp;平方米
    		   </td>
            </tr>
            ...
            <tr >
               ...
               <td  align="left">&nbsp; &nbsp; &nbsp; 
    		        <input class="inputText" id="buildingFloor" type="text" size="26" name="buildingFloor" value="<%= build.Floor %>" />&nbsp;&nbsp;&nbsp;层
    		   </td>
            </tr>
            ...
            <tr>
                    ...
                    <%for (int i = 0; i < imageList.Count; i++)
                      { %>                   
                        ...
                        <%--<img alt="" src="../../../Images/cancel.png" onclick="window.location.href='ViewBuilding.aspx?pageno=<%=pageno %>&id=<%=build.ID %>&imageID=<%=imageList[i].ID %> '" />--%>
                        <img alt="" src="../../../Images/cancel.png" class="DeleteImage" href="DeleteImage.aspx?id=<%=build.ID %>&imageID=<%=imageList[i].ID %>&pageno=<%=pageno %>" /> 
                    <%  if ((i + 1) % 4 == 0)
                        {%><br />
                        <%}
                      } %>
