<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateEmploye.aspx.cs" Inherits="Webmag_Employe_infoManage_employe_UpdateEmploye" %>
...
<body>
    ...
    <form name="editEmploye" action="DoUpdate.aspx?pageno=<%=pageno %>&oldid=<%=id %>" method="post" >
        <input type="hidden" name="employePWD" value="<%=employe.Password %>" />
        ...
        <table class="addTable" width="100%" cellspacing="0" cellpadding="0" style="border-collapse: collapse;">
            ...
            <tr>
               ...
               <td  align="left">&nbsp; &nbsp; &nbsp; 
    				<input class="inputText" id="employeID" type="text" readonly="readonly" size="26" name="employeID" value="<%=employe.EmployeID %>" />&nbsp;&nbsp;&nbsp;
            ...
            <tr >
               ...
               <td  align="left">&nbsp; &nbsp; &nbsp; 
    		        <input class="inputText" id="employeName" type="text" size="26" name="employeName" value="<%=employe.Name %>" />&nbsp;&nbsp;&nbsp;
    		   </td>
            </tr>
            ...
            <tr >
               ...
               <td  align="left">&nbsp; &nbsp; &nbsp; 
    		        <input class="inputText" id="employeIDNum" type="text" size="26" name="employeIDNum" value="<%=employe.IDNumber %>" />&nbsp;&nbsp;&nbsp;
    		   </td>
            </tr>
            ...
            <tr >
               ...
               <td  align="left">&nbsp; &nbsp; &nbsp; 
    		        <input class="inputText" id="employeNation" type="text" size="26" name="employeNation" value="<%=employe.Nation %>" />&nbsp;&nbsp;&nbsp;
    		   </td>
            </tr>
            ...
            <tr >
               ...
               <td  align="left">&nbsp; &nbsp; &nbsp;                
    		        <input class="inputText" id="employeBirth" type="text" size="26" name="employeBirth" value="<%= birth %>" />&nbsp;&nbsp;&nbsp;<img id="birthCalImg"  class="datepicker" src="../../../Images/cal.gif" />
    		   </td>
            </tr>
             ...
             <tr >
               ...
               <td  align="left">&nbsp; &nbsp; &nbsp; 
    		        <input class="inputText" id="employeOTel" type="text" size="26" name="employeOTel" value="<%=employe.OfficeTel %>" />&nbsp;&nbsp;&nbsp;
    		   </td>
            </tr>
             ...
             <tr >
               ...
               <td  align="left">&nbsp; &nbsp; &nbsp; 
    		        <input class="inputText" id="employeHTel" type="text" size="26" name="employeHTel" value="<%=employe.HomeTel%>" />&nbsp;&nbsp;&nbsp;
    		   </td>
            </tr>
             ...
             <tr >
               ...
               <td  align="left">&nbsp; &nbsp; &nbsp; 
    		        <input class="inputText" id="employeMobile" type="text" size="26" name="employeMobile" value="<%=employe.Mobile %>" />&nbsp;&nbsp;&nbsp;
    		   </td>
            </tr>
            ...
            <tr >
               ...
               <td  align="left">&nbsp; &nbsp; &nbsp; 
    		        <input class="inputText" id="employeAddress" type="text" size="60" name="employeAddress" value="<%=employe.HomeAddress %>" />&nbsp;&nbsp;&nbsp;
    		   </td>
            </tr>
             ...
             <tr >
               ...
               <td  align="left">&nbsp; &nbsp; &nbsp; 
    		        <input class="inputText" id="employeEmail" type="text" size="26" name="employeEmail" value="<%=employe.Email %>" />&nbsp;&nbsp;&nbsp;
    		   </td>
            </tr>
            ...
            <tr >
               ...
               <td  align="left">&nbsp; &nbsp; &nbsp; 
    		        <input class="inputText" id="employeEnter" type="text" size="26" name="employeEnter" value="<%= enterDate%>"" />&nbsp;&nbsp;&nbsp;<img id="enterCalImg"  class="datepicker" src="../../../Images/cal.gif" />
    		   </td>
            </tr>
            ...
            <tr >
               ...
               <td  align="left">&nbsp; &nbsp; &nbsp; 
    		        <input class="inputText" id="employeLeave" type="text" size="26" name="employeLeave" value="<%= leaveDate %>" />&nbsp;&nbsp;&nbsp;<img id="leaveCalImg"  class="datepicker" src="../../../Images/cal.gif" />
    		   </td>
            </tr>
