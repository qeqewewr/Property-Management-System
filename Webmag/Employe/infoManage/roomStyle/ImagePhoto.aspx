<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImagePhoto.aspx.cs" Inherits="Webmag_Employe_infoManage_roomStyle_ImagePhoto" %>
...
<body id="simple">
  <ul id="slider">
       ...
       <%for (int i = 0; i < imageList.Count; i++)
         {            
        %>
        <li><img src="<%=imageList[i].AttachUrl %>" alt="房型图"></li>
        <%} %>
