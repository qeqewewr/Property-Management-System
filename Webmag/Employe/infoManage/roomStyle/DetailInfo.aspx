<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DetailInfo.aspx.cs" Inherits="Webmag_Employe_infoManage_roomStyle_DetailInfo" %>
            ...
            <table width="100%" class="addTable" cellpadding="0"
                ...
                <tr>
				    <td colspan="4" class="buttonGroup">
					    <input name="backClose" type="button" class="backBtn" id="backClose" onclick="window.location.href='ViewRoomStyle.aspx?pageno=<%= pageno %> '" value=""/>	
