<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImagePhoto.aspx.cs" Inherits="Webmag_Employe_businadver_ImagePhoto" %>
...
<body id="simple">
  <ul id="slider">
       ...
       <%for (int i = 0; i < imageList.Count; i++)
        ...
        %>
        <li><img src="<%=imageList[i].AttachUrl %>" alt="企业展示图"></li>
        <%} %>
