<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewLesseeNotice.aspx.cs" Inherits="Webmag_Employe_officework_noticeann_ViewLesseeNotice" %>
    ...
    <div style="width: 100%">
			...
			<table class="resultTable">
              ...
              <form name="pageControlForm" action="DeleteMyNotice.aspx?page=<%= pageno %>&size=<%= page.PageSize %>&building=<%=building %>&room=<%=room %>" method="post"
				...
				<!--			<td>
							<input type="checkbox" name="selectDel" value="noticeList" onclick="isAllSelected(this,'sltAll','1')" />
							</td> 
                                   -->                                                                                                                                    <td><%= n.notice.Publisher%></td>                
							<td><%= n.notice.PublishDate%></td> 
                            
                            <td><%= n.notice.NoticeType%></td>
							<td>  <%= n.myNotice.ToBuilding%>- <%= n.myNotice.ToRoom%></td> 
				...
				<%} %>
					...
					<!--	<td> 
						...
						-->
						<td colspan="7" id="pageControl" style="text-align:left;padding-left:10px;">
                        <a href="ViewLesseeNotice.aspx?action=all">查看全部</a>
                        <a href="ViewLesseeNotice.aspx?action=unread">查看未读</a>
                        </td>
