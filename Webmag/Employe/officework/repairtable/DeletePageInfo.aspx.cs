...
public partial class Webmag_Employe_officework_repairtable_DeletePageInfo : System.Web.UI.Page
{
    protected string pageName = "ViewRepairTable.aspx";
    protected RepairTableDAO repairTableDAO;
    protected int pageno;
    protected int flag;
    protected List<RepairTable> repairlist;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            repairTableDAO = new RepairTableDAO();//---------------00
            //表的总记录数
            ...
            else
            {
                ...
                if (id != null)
                {
                    ...
                    flag = repairTableDAO.DeleteRepairTableById(id);//------------- 11
                ...
                else //删除多条记录
                {
                    ...
                    if (ids == null || ids == "")
                    {
                        Response.Redirect("ViewRepairTable.aspx?pageno=" + pageno + "&keyword=" + keyword + "&endtime=" + endtime + "");
                    }
                    ...
                    for (int i = 0; i < idArray.Length; i++)
                    {
                        flag = 1;
                        //----------------------------------5555---
                        imageList = imageDAO.GetImgAttachmentByTypeAndID(5, idArray[i]);
                        ...
                        if (flag <= 0)
                            break;
                        flag = repairTableDAO.DeleteRepairTableById(idArray[i]);//------------------22
                        if (flag <= 0)
                            break;
