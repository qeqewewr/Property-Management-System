...
public partial class Webmag_Employe_officework_answercomplain_DeleteImage : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (flag > 0)
            {
                Page.ClientScript.RegisterClientScriptBlock(Page.GetType(), "", "<script>alert('图片删除成功!');location.href=('UpdateComplainFeedback.aspx?pageno=" + pageno + "&id=" + id + "');</script>");
            }
            else
            {
