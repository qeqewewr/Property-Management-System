...
public partial class Webmag_Employe_quitorder_DeletePageInfo : System.Web.UI.Page
{
    protected string pageName = "ViewQuitOrder.aspx";
    protected QuitOrderDAO quitOrderDAO;
    protected int pageno;
    protected int flag;
    protected List<QuitOrder> orderlist;
        ...
        else
        {
            ...
            else
            {
                ...
                if (id != null)
                {
                    ...
                    flag = quitOrderDAO.DeleteQuitOrderById(id);//------------- 11
                ...
                else //删除多条记录
                {
                    ...
                    {
                        flag = quitOrderDAO.DeleteQuitOrderById(idArray[i]);//----------------------22
                        if (flag <= 0)
                            break;
